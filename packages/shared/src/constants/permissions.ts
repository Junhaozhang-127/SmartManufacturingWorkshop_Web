...
export const PermissionCodes = {
  ...
  creationView: buildPermissionCode(ResourceCode.CREATION, ActionCode.VIEW),
  creationCreate: buildPermissionCode(ResourceCode.CREATION, ActionCode.CREATE),
  creationUpdate: buildPermissionCode(ResourceCode.CREATION, ActionCode.UPDATE),
  knowledgeView: buildPermissionCode(ResourceCode.KNOWLEDGE, ActionCode.VIEW),
  portalContentView: buildPermissionCode(ResourceCode.PORTAL_CONTENT, ActionCode.VIEW),
  portalContentUpdate: buildPermissionCode(ResourceCode.PORTAL_CONTENT, ActionCode.UPDATE),
...
export const RolePermissionMap: Record<RoleCode, PermissionCode[]> = {
  ...
  [RoleCode.TEACHER]: [
    ...
    PermissionCodes.creationCreate,
    PermissionCodes.creationUpdate,
    PermissionCodes.knowledgeView,
    PermissionCodes.portalContentView,
    PermissionCodes.portalContentUpdate,
